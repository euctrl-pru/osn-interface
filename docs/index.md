...
R package for lazily querying [OpenSky
...
|----|----|
| [`osn_connect()`](https://euctrl-pru.github.io/osn-interface/reference/osn_connect.md) | Create a DuckDB connection configured for OSN S3 |
